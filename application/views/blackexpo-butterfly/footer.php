                        ...
                        <div class="footer-2 section">
                            <div class="logoImage">
                                <div class="widget-content">
                                    <img alt="" src="<?php echo base_url(); ?>template/<?php echo template(); ?>/images/dlh78.png">
                                </div>
                            </div>
            ...
            <div class="row divider py-4">
                <div class="col-lg-6">
                    <div class="copyright-section text-center text-lg-left">
                        © <script>document.write(new Date().getFullYear());</script> Copyright <a href="https://dlh.bekasikota.go.id/" target="_blank">Dinas Lingkungan Hidup Kota Bekasi</a> | All Rights Reserved
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="widget socialList">
                            <div class="widget-content">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo $pecahd[2]; ?>"><i class="fa  fa-instagram fa-3x"></i></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo $pecahd[3]; ?>"><i class="fa  fa-youtube fa-3x"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
